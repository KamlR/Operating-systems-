...
char *sem_name_parent; // Имя семафора, который контролирует запуск родительского процесса (сада).
char *sem_name_child_first; // Имя семафора, который контролирует запуск первого садовника.
char *sem_name_child_second; // Имя семафора, который контролирует запуск второго садовника.
