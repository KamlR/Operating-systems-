...
- В папке tests:
    - info1.txt - первая иллюстрация вывода программы
    - info2.txt - вторая иллюстрация вывода программы
### Как запускать:
